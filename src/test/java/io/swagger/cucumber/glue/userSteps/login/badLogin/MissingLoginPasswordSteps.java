...
public class MissingLoginPasswordSteps extends LoginBaseSteps
{
    @Given("^the following bad login information with missing password$")
    public void givenTheFollowingInfoWithMissingPassword(final UserLoginDTO loginUser)
    {
        this.loginUser = loginUser;
    }

    @When("^the customer logs in with the password missing")
    public void aCustomerLogsInWithMissingPassword() throws Exception
    {
    ...
    private void validateOutput()
    {
        ...
        Assertions.assertEquals("Password missing", output.getMessage());
    }
}
