...
public class ForbiddenExampleSwagger {
    /**
     * Get statusCode
     * @return statusCode
     **/
     ...
     * @return message
     **/
    @Schema(example = "You are not authorized to make this request.", description = "")
    private final String message;

    public ForbiddenExampleSwagger(int statusCode, Date timestamp, String message) {
    ...
    public boolean equals(Object o) {
        ...
        ForbiddenExampleSwagger exampleSwagger = (ForbiddenExampleSwagger) o;
    ...
    public String toString() {
        ...
        sb.append("class ForbiddenExampleSwagger {\n");
