...
public class UnauthorizedExampleSwagger {
    /**
     * Get statusCode
     * @return statusCode
     **/
     ...
     * @return message
     **/
    @Schema(example = "Credentials invalid or missing.", description = "")
    private final String message;

    public UnauthorizedExampleSwagger(int statusCode, Date timestamp, String message) {
    ...
    public boolean equals(Object o) {
        ...
        UnauthorizedExampleSwagger exampleSwagger = (UnauthorizedExampleSwagger) o;
    ...
    public String toString() {
        ...
        sb.append("class UnauthorizedExampleSwagger {\n");
