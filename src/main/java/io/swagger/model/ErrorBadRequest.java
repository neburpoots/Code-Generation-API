...
public class ErrorBadRequest   {
  ...
  public ErrorBadRequest description(String description) {
   ...
   * @return description
   **/
  @Schema(example = "The request was invalid or cannot be served.", required = true, description = "")
      @NotNull
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.description, errorBadRequest.description);
  }
